...
public sealed record SliRuntimeRealizationProfile(
    ...
    int MaxTraceEntries,
    int MaxResidueCount,
    int MaxWitnessOperationCount,
    int MaxTransportOperationCount,
    ...
    bool SupportsSymbolicTrace)
{
    public static SliRuntimeRealizationProfile CreateHostManaged(string profileId = "host-managed-runtime")
    {
        return new SliRuntimeRealizationProfile(
            ...
            BudgetClass: "host-unbounded",
            CommitAuthorityClass: "host-governed",
            MaxInstructionCount: int.MaxValue,
            MaxSymbolicDepth: int.MaxValue,
            MaxTraceEntries: int.MaxValue,
            MaxResidueCount: int.MaxValue,
            MaxWitnessOperationCount: int.MaxValue,
            MaxTransportOperationCount: int.MaxValue,
    ...
    public static SliRuntimeRealizationProfile CreateTargetBounded(
        ...
        int maxTraceEntries = 512,
        int maxResidueCount = 64,
        int maxWitnessOperationCount = 16,
        int maxTransportOperationCount = 16,
        string residencyClass = "target-bounded",
        string budgetClass = "target-bounded-lane",
        string commitAuthorityClass = "refusal-only")
    {
        return new SliRuntimeRealizationProfile(
            ProfileId: profileId,
            ResidencyClass: residencyClass,
            BudgetClass: budgetClass,
            CommitAuthorityClass: commitAuthorityClass,
            MaxInstructionCount: maxInstructionCount,
            MaxSymbolicDepth: maxSymbolicDepth,
            MaxTraceEntries: maxTraceEntries,
            MaxResidueCount: maxResidueCount,
            MaxWitnessOperationCount: maxWitnessOperationCount,
            MaxTransportOperationCount: maxTransportOperationCount,
