...
public sealed record GovernedSeedOperationalContext(
    ...
    string? PostParticipationExecutionPacketHandle = null,
    string? PostExecutionOperationalActionPacketHandle = null,
...
public sealed record GovernedSeedVerticalSlice(
    ...
    GovernedSeedServiceBehaviorAssessment? ServiceBehaviorAssessment = null,
