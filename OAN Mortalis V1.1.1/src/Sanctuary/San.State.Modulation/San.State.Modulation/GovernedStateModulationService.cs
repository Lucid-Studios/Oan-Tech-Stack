...
public sealed class GovernedStateModulationService : IGovernedStateModulationService
{
        ...
        GovernedSeedEvaluationResult evaluationResult)
    {
        ...
        return new GovernedSeedStateModulationReceipt(
            ...
            ExecutionAuthorized: operationalContext?.ExecutionAuthorized,
            PostExecutionOperationalActionReceiptHandle: operationalContext?.PostExecutionOperationalActionReceiptHandle,
            PostExecutionOperationalActionDisposition: operationalContext?.PostExecutionOperationalActionDisposition,
        ServiceEffectAuthorized: operationalContext?.ServiceEffectAuthorized,
        CommitIntentPresent: operationalContext?.CommitIntentPresent,
        ...
        ServiceEnactmentCommitReady: operationalContext?.ServiceEnactmentCommitReady,
        ServiceEnactmentCommitted: operationalContext?.ServiceEnactmentCommitted,
