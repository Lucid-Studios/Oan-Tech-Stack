# Example: Review Gate Summary

This is a non-executable example of how a public release gate can be summarized.

| Question | Public Answer |
| --- | --- |
| Is this material descriptive? | Yes |
| Does it include source code? | No |
